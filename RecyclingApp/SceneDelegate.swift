...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let contentView = LocationsView().environmentObject(locationViewModel)
    ...
    func checkUserStatus() {
        ...
        if UserDefaults.standard.hasLogged {
            ...
            controller = storyboard.instantiateViewController(withIdentifier: "InitialViewController") as? UINavigationController
        }
